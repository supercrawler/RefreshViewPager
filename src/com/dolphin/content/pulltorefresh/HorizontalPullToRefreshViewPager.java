...
public class HorizontalPullToRefreshViewPager extends PullToRefreshBase<ViewPager> {

    public HorizontalPullToRefreshViewPager(Context context) {
        super(context);
    }

    public HorizontalPullToRefreshViewPager(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
